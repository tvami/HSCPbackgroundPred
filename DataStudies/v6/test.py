...
if __name__ == "__main__":
    ...
    plot_fit()
    GOF(condor=False, extra='--text2workspace "--channel-masks" --setParametersForFit mask_pass_SIG=1,mask_pass_HIGH=1 --setParametersForEval mask_pass_SIG=1,mask_pass_HIGH=1')
