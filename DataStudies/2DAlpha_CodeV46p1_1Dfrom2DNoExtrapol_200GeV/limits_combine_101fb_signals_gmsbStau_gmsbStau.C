void limits_combine_101fb_signals_gmsbStau_gmsbStau()
{
//=========Macro generated from canvas: climits/climits
//=========  (Fri Jan 12 00:00:47 2024) by ROOT version 6.14/09
   ...
   graph->Draw("l");
   TLine *line = new TLine(0.584164,-1111,0.584164,0.0007728636);
   line->SetLineStyle(2);
   line->Draw();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.579164,0,"  0.58 TeV");
   tex->SetTextFont(43);
   tex->SetTextSize(14);
   tex->SetTextAngle(90);
   tex->SetLineWidth(2);
