void limits_combine_101fb_signals_ppStau_R_ppStauR()
{
//=========Macro generated from canvas: climits/climits
//=========  (Fri Jan 19 17:00:22 2024) by ROOT version 6.14/09
   ...
   Graph_Graph7->SetMinimum(2.738711e-06);
   ...
   graph->Draw("l");
   TLine *line = new TLine(0.5177059,-1111,0.5177059,0.0001640088);
   line->SetLineStyle(2);
   line->Draw();
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.5484222,0,0.5484222,0.0001223382);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(0.5434222,0,"  0.55 TeV");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.5127059,0,"  0.52 TeV");
   tex->SetTextFont(43);
   tex->SetTextSize(14);
   tex->SetTextAngle(90);
   tex->SetLineWidth(2);
