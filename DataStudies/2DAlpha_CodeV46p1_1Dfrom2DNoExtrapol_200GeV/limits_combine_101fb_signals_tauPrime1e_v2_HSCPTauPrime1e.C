void limits_combine_101fb_signals_tauPrime1e_v2_HSCPTauPrime1e()
{
//=========Macro generated from canvas: climits/climits
//=========  (Fri Jan 12 00:01:20 2024) by ROOT version 6.14/09
   ...
   Graph_Graph12->SetMinimum(6.607399e-07);
   Graph_Graph12->SetMaximum(0.0001032703);
   ...
   Graph_Graph23->SetMinimum(9.88946e-06);
   Graph_Graph23->SetMaximum(5.968336e-05);
   ...
   Graph_Graph34->SetMinimum(2.279385e-05);
   Graph_Graph34->SetMaximum(3.224591e-05);
   ...
   Graph_Graph7->SetMaximum(0.002316593);
   ...
   Graph_Graph8->SetMaximum(0.002831392);
   ...
   graph->Draw("l");
   TLine *line = new TLine(1.307145,-1111,1.307145,3.093471e-05);
   line->SetLineStyle(2);
   line->Draw();
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.356949,0,1.356949,2.360859e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(1.351949,0,"  1.36 TeV");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(1.302145,0,"  1.31 TeV");
   tex->SetTextFont(43);
   tex->SetTextSize(14);
   tex->SetTextAngle(90);
   tex->SetLineWidth(2);
