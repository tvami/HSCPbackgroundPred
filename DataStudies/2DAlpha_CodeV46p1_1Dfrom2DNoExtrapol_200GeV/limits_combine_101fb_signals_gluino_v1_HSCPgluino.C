void limits_combine_101fb_signals_gluino_v1_HSCPgluino()
{
//=========Macro generated from canvas: climits/climits
//=========  (Fri Jan 12 00:00:13 2024) by ROOT version 6.14/09
   ...
   Graph_Graph12->SetMinimum(0.0001268921);
   Graph_Graph12->SetMaximum(0.002529649);
   ...
   Graph_Graph23->SetMinimum(0.0001364306);
   Graph_Graph23->SetMaximum(0.001460079);
   ...
   Graph_Graph34->SetMinimum(0.0004570792);
   Graph_Graph34->SetMaximum(0.0007963473);
   ...
   graph->Draw("l");
   TLine *line = new TLine(2.032746,-1111,2.032746,0.0008514783);
   line->SetLineStyle(2);
   line->Draw();
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.0798,0,2.0798,0.000666231);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(2.0748,0,"  2.08 TeV");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(2.027746,0,"  2.03 TeV");
   tex->SetTextFont(43);
   tex->SetTextSize(14);
   tex->SetTextAngle(90);
   tex->SetLineWidth(2);
