...
//=========  (Fri Jan 19 01:33:48 2024) by ROOT version 6.14/09
   ...
   graph->Draw("l");
   TLine *line = new TLine(0.6920448,-1111,0.6920448,0.0001321359);
   line->SetLineStyle(2);
   line->Draw();
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.7274424,0,0.7274424,0.0001003954);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(0.7224424,0,"  0.73 TeV");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.6870448,0,"  0.69 TeV");
   tex->SetTextFont(43);
   tex->SetTextSize(14);
   tex->SetTextAngle(90);
   tex->SetLineWidth(2);
