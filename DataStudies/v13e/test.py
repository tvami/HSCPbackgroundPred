...
if __name__ == "__main__":
    make_workspace()
    perform_fit('gluino-800','0x0',rMaxExt=35,extra='--robustHesse 1')
    perform_fit('gluino-1000','0x0',rMaxExt=30,extra='--robustHesse 1')
    perform_fit('gluino-1400','0x0',rMaxExt=10,extra='--robustHesse 1')
    perform_fit('gluino-1600','0x0',rMaxExt=30,extra='--robustHesse 1')
    perform_fit('gluino-1800','0x0',rMaxExt=30,extra='--robustHesse 1')
    perform_fit('gluino-2000','0x0',rMaxExt=30,extra='--robustHesse 1')
    perform_fit('gluino-2200','0x0',rMaxExt=30,extra='--robustHesse 1')
    perform_fit('gluino-2400','0x0',rMaxExt=0.0000001,extra='--robustHesse 1')
    perform_fit('gluino-2600','0x0',rMaxExt=0.0000001,extra='--robustHesse 1')
