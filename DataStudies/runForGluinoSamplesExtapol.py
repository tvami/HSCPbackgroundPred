...
def make_workspace():
  ...
  twoD = TwoDAlphabet('HSCP_fits', 'configForGluinoSamplesExtrap.json', loadPrevious=False)
  ...
  for f, p in [_get_other_region_names(r) for r in twoD.ledger.GetRegions() if 'fail' in r]:
    ...
    bkg_f = SemiParametricFunction(fail_name, bkg_hists[f], binning_f, bkg_f_func, constraints=bkg_f_const,funcCeiling=3.)
...
if __name__ == "__main__":
    ...
    perform_fit('gluino-2400','0x0',rMaxExt=0.01,extra='--robustHesse 1')
