void limits_combine_101fb_signals_ZPrimeSSM_TauAt600_ZPrime()
{
//=========Macro generated from canvas: climits/climits
//=========  (Fri Jan 12 01:50:03 2024) by ROOT version 6.14/09
   ...
   graph->Draw("l");
   TLine *line = new TLine(4.412706,-1111,4.412706,6.429921e-05);
   line->SetLineStyle(2);
   line->Draw();
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(4.557928,0,4.557928,4.672089e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(4.552928,0,"  4.56 TeV");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(4.407706,0,"  4.41 TeV");
   tex->SetTextFont(43);
   tex->SetTextSize(14);
   tex->SetTextAngle(90);
   tex->SetLineWidth(2);
