void limits_combine_101fb_signals_ZPrimePsi_TauAt600_ZPrime()
{
//=========Macro generated from canvas: climits/climits
//=========  (Fri Jan 12 01:49:44 2024) by ROOT version 6.14/09
   ...
   graph->Draw("l");
   TLine *line = new TLine(3.880352,-1111,3.880352,6.246695e-05);
   line->SetLineStyle(2);
   line->Draw();
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(62);
   entry=leg->AddEntry("","#sigma^{NNLO+NNLL}_{th}(pp#rightarrow Z_{#psi}' #rightarrow #tau'^{2e}#tau'^{2e})#pm1#sigma","l");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(4.014379,0,4.014379,4.626875e-05);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(4.009379,0,"  4.01 TeV");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(3.875352,0,"  3.88 TeV");
   tex->SetTextFont(43);
   tex->SetTextSize(14);
   tex->SetTextAngle(90);
   tex->SetLineWidth(2);
