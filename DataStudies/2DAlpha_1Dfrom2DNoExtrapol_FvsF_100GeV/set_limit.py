...
print('Theory xsection limit @ 200 GeV: '+str(round(graphWP.Eval(0.2),6)) + ' pb')
print('Theory xsection limit @ 247 GeV: '+str(round(graphWP.Eval(0.247),6)) + ' pb')
print('Theory xsection limit @ 308 GeV: '+str(round(graphWP.Eval(0.308),6)) + ' pb')
print('Theory xsection limit @ 432 GeV: '+str(round(graphWP.Eval(0.432),6)) + ' pb')
print('Theory xsection limit @ 557 GeV: '+str(round(graphWP.Eval(0.557),6)) + ' pb')
print('Theory xsection limit @ 651 GeV: '+str(round(graphWP.Eval(0.651),6)) + ' pb')
print('Theory xsection limit @ 745 GeV: '+str(round(graphWP.Eval(0.745),10)) + ' pb')
print('Theory xsection limit @ 871 GeV: '+str(round(graphWP.Eval(0.871),10)) + ' pb')
print('Theory xsection limit @ 1029 GeV: '+str(round(graphWP.Eval(1.029),10)) + ' pb')
print('Theory xsection limit @ 1218 GeV: '+str(round(graphWP.Eval(1.218),6)) + ' pb')
print('Theory xsection limit @ 1409 GeV: '+str(round(graphWP.Eval(1.409),6)) + ' pb')
print('Theory xsection limit @ 1599 GeV: '+str(round(graphWP.Eval(1.599),6)) + ' pb')
