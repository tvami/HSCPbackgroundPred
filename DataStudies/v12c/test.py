...
if __name__ == "__main__":
    #make_workspace()
    #perform_fit('gluino-800','0x0',rMaxExt=0.001,extra='--robustHesse 1')
    #perform_fit('gluino-1000','0x0',rMaxExt=0.1,extra='--robustHesse 1')
    #perform_fit('gluino-1400','0x0',rMaxExt=0.01,extra='--robustHesse 1')
    #perform_fit('gluino-1600','0x0',rMaxExt=0.1,extra='--robustHesse 1')
    ...
    #perform_fit('gluino-2400','0x0',rMaxExt=4,extra='--robustHesse 1')
    #perform_fit('gluino-2600','0x0',rMaxExt=4,extra='--robustHesse 1')
    #perform_fit('gluino-1800','1x0',rMaxExt=0.1,extra='--robustHesse 1')
    #perform_fit('gluino-1800','2x0',rMaxExt=0.1,extra='--robustHesse 1')
