...
def make_workspace():
  ...
  twoD = TwoDAlphabet('./', 'configForGluinoSamples.json', loadPrevious=False)
...
if __name__ == "__main__":
    ...
    #perform_fit('gluino-1000','0x0',rMaxExt=0.1,extra='--robustHesse 1')
    #perform_fit('gluino-1400','0x0',rMaxExt=30,extra='--robustHesse 1')
    #perform_fit('gluino-1600','0x0',rMaxExt=30,extra='--robustHesse 1')
    #perform_fit('gluino-1800','0x0',rMaxExt=10,extra='--robustHesse 1')
    #perform_fit('gluino-2000','0x0',rMaxExt=30,extra='--robustHesse 1')
    #perform_fit('gluino-2200','0x0',rMaxExt=30,extra='--robustHesse 1')
    #perform_fit('gluino-2400','0x0',rMaxExt=40,extra='--robustHesse 1')
    #perform_fit('gluino-2600','0x0',rMaxExt=10,extra='--robustHesse 1')
